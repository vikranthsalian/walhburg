(function($) {
	...
	if ($('.four-item-carousel').length) {
		...
		var twoItemCarousel = new Swiper('.five-item-carousel', {
			...
			navigation: {
				nextEl: '.slider-button1-next4',
				prevEl: '.slider-button1-prev4',
			},
			breakpoints: {
				1400: {
					slidesPerView: 4,
	...
	if ($('.fourr-item-carousel').length) {
		var twoItemCarousel = new Swiper('.fourr-item-carousel', {
			preloadImages: false,
			loop: false,
			grabCursor: false,
			centeredSlides: false,
	...
	if ($('.client-item-carousel').length) {
		var twoItemCarousel = new Swiper('.client-item-carousel', {
			preloadImages: true,
			loop: true,
			slidesPerView: 6,
			speed: 800,
...
/*owl Carousel*/
$('.clients-item-carousel').owlCarousel({
    loop: true,
    ...
    autoplaySpeed: 1000, // Speed of autoplay transitions (1 second)
    smartSpeed: 700, 
    responsive: {
        0: {
            items: 2,
